/*
  ...
  - You are about to drop the `BuildingDimensions` table. If the table is not empty, all the data it contains will be lost.
...
*/
-- AlterTable
ALTER TABLE "CustomInputElement" ADD COLUMN "group" TEXT;
